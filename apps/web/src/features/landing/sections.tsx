  ...
  return (
    <div ref={containerRef} className="w-full h-full flex flex-col bg-[#17181c] select-none text-white font-mono p-4 items-center justify-between border-[3px] border-black rounded-none relative overflow-hidden">
      ...
      <div className="flex-1 w-full flex items-center justify-center overflow-hidden py-2">
        ...
        >
          {activeTheme === "tech" && (
            <div className="w-full h-full relative" style={{ backgroundImage: "url('/ui/tiles/floor_gray.png')", backgroundSize: "48px 48px" }}>
              <div className="absolute left-0 top-0 w-[720px] h-[44px]" style={{ backgroundImage: "url('/ui/tiles/wall_gray.png')", backgroundSize: "48px 44px" }} />
              <div className="absolute left-0 top-[44px] w-[336px] h-[212px]" style={{ backgroundImage: "url('/ui/tiles/carpet_blue.png')", backgroundSize: "48px 48px", boxShadow: "inset -4px -4px 0 rgba(30,35,48,.55)" }} />
              ...
              <div className="absolute left-[384px] top-[44px] w-[336px] h-[196px]" style={{ backgroundImage: "url('/ui/tiles/floor_beige.png')", backgroundSize: "48px 48px", boxShadow: "inset 4px -4px 0 rgba(30,35,48,.55)" }} />
              ...
              <div className="absolute left-[448px] top-[308px] w-[272px] h-[182px]" style={{ backgroundImage: "url('/ui/tiles/floor_cream.png')", backgroundSize: "48px 48px", boxShadow: "inset 4px 4px 0 rgba(30,35,48,.55)" }} />
              ...
              <div className="absolute select-none flex flex-col items-center gap-0.5 z-20" style={{ left: 150, top: 236, width: 64 }}>
                ...
                <img src="/ui/chars/f10.png" alt="" style={{ width: 40, imageRendering: "pixelated" }} />
              </div>
              <div className="absolute select-none flex flex-col items-center gap-0.5 z-20" style={{ left: 600, top: 368, width: 64 }}>
                ...
                <img src="/ui/chars/f12.png" alt="" style={{ width: 36, imageRendering: "pixelated" }} />
              </div>
              <div className="absolute flex flex-col items-center gap-0.5 transition-all duration-500 ease-out z-30" style={{ left: techPos.x, top: techPos.y, width: 64 }}>
                ...
                <img src="/ui/chars/f00.png" alt="" style={{ width: 38, imageRendering: "pixelated" }} />
              </div>
            </div>
          )}
          {activeTheme === "zen" && (
            <div className="w-full h-full relative" style={{ backgroundImage: "url('/ui/tiles/wood_honey.png')", backgroundSize: "48px 48px" }}>
              <div className="absolute left-0 top-0 w-[720px] h-[44px]" style={{ backgroundImage: "url('/ui/tiles/wall_tan.png')", backgroundSize: "48px 44px" }} />
              <div className="absolute left-[216px] top-[140px] w-[288px] h-[220px] rounded-[14px]" style={{ backgroundImage: "url('/ui/tiles/carpet_sage.png')", backgroundSize: "48px 48px", border: "4px solid rgba(90,110,80,.5)" }} />
              ...
              <div className="absolute select-none flex flex-col items-center gap-0.5 z-20" style={{ left: 130, top: 340, width: 64 }}>
                ...
                <img src="/ui/chars/f04.png" alt="" style={{ width: 38, imageRendering: "pixelated" }} />
              </div>
              <div className="absolute flex flex-col items-center gap-0.5 transition-all duration-500 ease-out z-30" style={{ left: zenPos.x, top: zenPos.y, width: 64 }}>
                ...
                <img src="/ui/chars/f18.png" alt="" style={{ width: 40, imageRendering: "pixelated" }} />
              </div>
            </div>
          )}
          {activeTheme === "library" && (
            <div className="w-full h-full relative" style={{ backgroundImage: "url('/ui/tiles/wood_dark.png')", backgroundSize: "48px 48px" }}>
              <div className="absolute left-0 top-0 w-[720px] h-[44px]" style={{ backgroundImage: "url('/ui/tiles/wall_mauve.png')", backgroundSize: "48px 44px" }} />
              <div className="absolute left-0 top-[190px] w-[340px] h-[300px]" style={{ backgroundImage: "url('/ui/tiles/carpet_red.png')", backgroundSize: "48px 48px", boxShadow: "inset -4px 0 0 rgba(25,18,16,.6)" }} />
              ...
              <div className="absolute left-[420px] top-[210px] w-[300px] h-[280px]" style={{ backgroundImage: "url('/ui/tiles/floor_mauve.png')", backgroundSize: "48px 48px", boxShadow: "inset 4px 0 0 rgba(25,18,16,.6)" }} />
              ...
              <div className="absolute select-none flex flex-col items-center gap-0.5 z-20" style={{ left: 60, top: 120, width: 64 }}>
                ...
                <img src="/ui/chars/f26.png" alt="" style={{ width: 38, imageRendering: "pixelated" }} />
              </div>
              <div className="absolute flex flex-col items-center gap-0.5 transition-all duration-500 ease-out z-30" style={{ left: libPos.x, top: libPos.y, width: 64 }}>
                ...
                <img src="/ui/chars/f22.png" alt="" style={{ width: 36, imageRendering: "pixelated" }} />
              </div>
            </div>
          )}
          {activeTheme === "cafe" && (
            <div className="w-full h-full relative" style={{ backgroundImage: "url('/ui/tiles/wood_light.png')", backgroundSize: "48px 48px" }}>
              <div className="absolute left-0 top-0 w-[720px] h-[44px]" style={{ backgroundImage: "url('/ui/tiles/wall_cream.png')", backgroundSize: "48px 44px" }} />
              <div className="absolute left-[490px] top-[44px] w-[230px] h-[180px]" style={{ backgroundImage: "url('/ui/tiles/floor_tan.png')", backgroundSize: "48px 48px", boxShadow: "inset 4px -4px 0 rgba(60,45,30,.4)" }} />
              ...
              <div className="absolute left-[36px] top-[120px] w-[400px] h-[250px] rounded-[12px]" style={{ backgroundImage: "url('/ui/tiles/carpet_gold.png')", backgroundSize: "48px 48px", border: "4px solid rgba(140,105,40,.45)" }} />
              ...
              <div className="absolute select-none flex flex-col items-center gap-0.5 z-20" style={{ left: 300, top: 206, width: 64 }}>
                ...
                <img src="/ui/chars/f08.png" alt="" style={{ width: 38, imageRendering: "pixelated" }} />
              </div>
              <div className="absolute select-none flex flex-col items-center gap-0.5 z-20" style={{ left: 600, top: 330, width: 64 }}>
                ...
                <img src="/ui/chars/f02.png" alt="" style={{ width: 40, imageRendering: "pixelated" }} />
              </div>
              <div className="absolute flex flex-col items-center gap-0.5 transition-all duration-500 ease-out z-30" style={{ left: cafePos.x, top: cafePos.y, width: 64 }}>
                ...
                <img src="/ui/chars/f24.png" alt="" style={{ width: 40, imageRendering: "pixelated" }} />
              </div>
            </div>
          )}
        </div>
...
function PixelOfficeScene() {
  return (
    ...
    >
      ...
      <img src="/ui/furniture/office/window.png" alt="" style={{ position: "absolute", left: 56, top: 28, width: 96, imageRendering: "pixelated" }} />
      <img src="/ui/furniture/office/whiteboard.png" alt="" style={{ position: "absolute", left: 420, top: 30, width: 128, imageRendering: "pixelated" }} />
      <img src="/ui/furniture/office/wall_clock.png" alt="" style={{ position: "absolute", left: 640, top: 36, width: 56, imageRendering: "pixelated" }} />
      <img src="/ui/furniture/office/painting.png" alt="" style={{ position: "absolute", left: 930, top: 34, width: 72, imageRendering: "pixelated" }} />
      <img src="/ui/furniture/office/desk.png" alt="" style={{ position: "absolute", left: 120, top: 150, width: 170, imageRendering: "pixelated" }} />
      <img src="/ui/furniture/office/pc.png" alt="" style={{ position: "absolute", left: 160, top: 96, width: 80, imageRendering: "pixelated" }} />
      <img src="/ui/furniture/office/chair.png" alt="" style={{ position: "absolute", left: 300, top: 180, width: 66, imageRendering: "pixelated" }} />
      <img src="/ui/furniture/office/meeting_table.png" alt="" style={{ position: "absolute", left: 480, top: 170, width: 180, imageRendering: "pixelated" }} />
      <img src="/ui/furniture/office/sofa.png" alt="" style={{ position: "absolute", left: 730, top: 160, width: 140, imageRendering: "pixelated" }} />
      <img src="/ui/furniture/office/floor_lamp.png" alt="" style={{ position: "absolute", left: 890, top: 130, width: 58, imageRendering: "pixelated" }} />
      <img src="/ui/furniture/office/plant.png" alt="" style={{ position: "absolute", left: 1000, top: 160, width: 80, imageRendering: "pixelated" }} />
      <img src="/ui/furniture/office/water_cooler.png" alt="" style={{ position: "absolute", left: 1130, top: 150, width: 60, imageRendering: "pixelated" }} />
      {/* avatar labels */}
